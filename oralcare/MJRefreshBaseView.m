...
- (UIImageView *)activityView
{
    if (!_activityView) {
        ...
        activityView.frame=CGRectMake(300, 200, 50, 50);
        activityView.image=[UIImage imageNamed:@"taidi.jpg"];
...
- (void)layoutSubviews
{
 ...
 //self.activityView.center = self.arrowImage.center;
    //
self.activityView.center=CGPointMake(self.arrowImage.center.x, self.arrowImage.center.y);
}
...
-(void)startAnimation1
{
    ...
    self.activityView.transform = CGAffineTransformMakeRotation(angle * (M_PI / 180.0f));
